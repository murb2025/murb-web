...
export const DataTable = ({
	...
	const updateCommentMutation = trpc.feedback.updateComment.useMutation({
		onSuccess: () => {
			refetchComments();
	...
	const handleAddComment = () => {
		if (selectedReview && commentContent.trim()) {
					...
					{!isLoading &&
						...
						data.map((item, index: number) => (
							<TableRow key={index}>
								...
								<TableCell className="text-center whitespace-nowrap">{item?.eventTitle}</TableCell>
