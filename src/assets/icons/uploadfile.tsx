/**
 * SolarFileSendLinear icon component
 * Part of the Solar icon set - represents a file upload/send action
...
export function SolarFileSendLinear(props: SVGProps<SVGSVGElement>) {
	return (
		<svg
